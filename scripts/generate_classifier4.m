function result = generate_classifier4(pattern_vertical, pattern_horizontal)

size_step = 1.3;
max_vertical = floor((pattern_vertical - 1) / 3);
...
positive_rectangles(2, 1) = vertical_offset + 2 * vertical_size; % top
positive_rectangles(2, 2) = vertical_offset + 3 * vertical_size - 1; % bottom
positive_rectangles(2, 3) = horizontal_offset; % left
positive_rectangles(2, 4) =  horizontal_offset + horizontal_size - 1; % right
...
result = {positive_rectangles, negative_rectangles, ...
          4, -2, vertical_size, horizontal_size, ...
          vertical_offset, horizontal_offset, ...
          rectangle_filter4(vertical_size, horizontal_size)};
